...
export const NAV: Record<Role, NavItem[]> = {
  ...
  CHIEF_MENTOR: [
    ...
    { label: "Parents", href: "/chief/parents", icon: "Contact" },
    { label: "Applications", href: "/chief/applications", icon: "ClipboardList" },
    { label: "Mentor Applications", href: "/chief/mentor-applications", icon: "UserCheck" },
    { label: "Institutions", href: "/chief/institutions", icon: "Building2" },
    { label: "Assessments", href: "/chief/assessments", icon: "FileBarChart" },
    { label: "Sessions", href: "/chief/sessions", icon: "CalendarDays" },
    { label: "Reports", href: "/chief/reports", icon: "FileText" },
    { label: "Feedback", href: "/chief/feedback", icon: "MessageCircle" },
  ...
  SUPERVISOR: [
    ...
    { label: "Parents", href: "/supervisor/parents", icon: "Contact" },
    { label: "Applications", href: "/supervisor/applications", icon: "ClipboardList" },
    { label: "Mentor Applications", href: "/supervisor/mentor-applications", icon: "UserCheck" },
    { label: "Institutions", href: "/supervisor/institutions", icon: "Building2" },
  ...
  MENTOR: [
    ...
    { label: "Parents", href: "/mentor/parents", icon: "Contact" },
    { label: "Institutions", href: "/mentor/institutions", icon: "Building2" },
