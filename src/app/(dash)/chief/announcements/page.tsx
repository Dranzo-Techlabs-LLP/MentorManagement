...
/** Program-wide announcements managed by the chief mentor. */
export default async function ChiefAnnouncementsPage() {
      ...
      {announcements.length === 0 ? (
        <Panel>
          <EmptyState
            ...
            hint="Create your first announcement to broadcast to the program."
